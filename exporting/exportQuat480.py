...
def process_file_rotations(filename, window=480, window_step=240):
...
data_clips -= mean
data_clips /= std
np.savez_compressed('cmu_rotations_Quat_cmu_20_standardized_w480_ws240_normalfps_scaled{}'.format(scale), clips=data_clips, std=std, mean=mean, scale=scale)
