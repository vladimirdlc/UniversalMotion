...
fileChanged = "cmu_rotations_full_cmu_31_nonchanged"
print(fileChanged)
...
network.add(Dropout(0.20, input_shape=(windowSize, degreesOFreedom)))
network.add(Conv1D(degreesOFreedom, kernel_size, use_bias=True, activation='relu', padding='same', strides=2, input_shape=(windowSize, degreesOFreedom)))
